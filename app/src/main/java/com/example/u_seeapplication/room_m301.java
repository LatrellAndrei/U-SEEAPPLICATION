...
public class room_m301 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.room_m301);
        ...
        dashbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(room_m301.this, Dashboard.class);
                startActivity(i);
            }
        });
        ...
        btnroom.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(room_m301.this, search_rooms_listview.class);
                startActivity(i);
            }
        });
