...
public class room_m210 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.room_m210);
        ...
        dashbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(room_m210.this, Dashboard.class);
                startActivity(i);
            }
        });
        ...
        btnroom.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(room_m210.this, search_rooms_listview.class);
                startActivity(i);
            }
        });
    }
