...
public class room_m307 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.room_m307);
        ...
        dashbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(room_m307.this, Dashboard.class);
                startActivity(i);
            }
        });
        ...
        btnroom.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(room_m307.this, search_rooms_listview.class);
                startActivity(i);
            }
        });
    }
